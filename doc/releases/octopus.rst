...
* When upgrading from a previous cephadm release, please redeploy iSCSI, NFS and the monitoring stack. Please run the following to upgrade the rest of the services::
